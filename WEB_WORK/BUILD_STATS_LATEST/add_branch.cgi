...
';
print '<tr><td><span style="color:white; font-size: 10pt;font-weight: bold;">BRANCH NAME:&nbsp</span></td>&nbsp<td><input type="text" name="br_no" /></td></tr><tr><td>&nbsp</td><td>&nbsp</td></tr>';
print '</table>';
