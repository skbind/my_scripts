...
# -v integ-MK2_THROTTLE_C2K_BUNDLE_VIEW_DONT_DELETE # view name
# -i CSCur64967 # Common Bug ID
# -p $RT_BUILD_PARTITION # LOG partition
# -e isbuweb # alias to mail.
# -b $RT_BRANCH_NAME # which branch
# -ver $RT_VERSION_ID # build version ID
# -l $RT_LOGDIR  # current build log directory(RT_LOGDIR) name
...
viewExists($view_name); # view validation if view exists.
...
# TILL HERE ONLY VALIDATION OF ARGUMENTS.
